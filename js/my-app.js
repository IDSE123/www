...
function popInternlist2(stuId){
    ...
    $.getJSON("https://www.kportals.com/cyberIntern/app/dbJson.php", function(data){
              ...
              $.each(data, function(index, value){
                     ...
                     toAppend += "<a href=\"job_desc.html\" onclick=\"IntDesc1('"+value.position+"','"+value[23]+"','"+value.location+"','"+value[22]+"','"+value.openingcount+"','"+value.requirements+"','"+value.workexp+"','"+value.description+"','"+value.minsalary+" - "+value.maxsalary+"',"+stuId+","+value.idjob+")\"><li><div class=\"item-content\"><div class=\"post_entry\"><div class=\"post_thumb\"><img src=\""+value[22]+"\" alt=\"\" title=\"\" /></div><div class=\"post_details\"><h2>"+value.position+"</h2><p>"+value[23]+"</p><span class=\"post_date\">"+value.createdat+"</span><span class=\"post_comments\"><a href=\"#\"></a></span></div></div></div></li></a>";
...
function intr(posi,comp,loc,imSrc,opCount,req,woexp,desc,salD,stuId,jId){
    ...
    alert(posi+" "+comp+" "+loc+" "+imSrc+" "+opCount+" "+req+" "+woexp+" "+desc+" "+salD+" "+stuId+" "+jId);
    $("#headBlk").html("");
    $("#headBlk").html(posi);
    $("#headBlk2").html("");
    $("#headBlk2").html(comp);
   ...
   // }
    ...
    $.getJSON("https://www.kportals.com/cyberIntern/app/dbJson.php", function(data){
              ...
              $.each(data, function(index, value){
                     ...
                     toAppender += "<div id='jl"+value.idjob+"'><a href=\"job_desc.html\" onclick=\"IntDesc2('"+value.position+"','"+value[23]+"','"+value.location+" "+value[9]+"','"+value[22]+"','"+value.openingcount+"','"+value.requirements+"','"+value.workexp+"','"+value.description+"','"+value.minsalary+" - "+value.maxsalary+"',"+stuIds+","+value.idjob+")\"><li class=\"swipeout\"><div class=\"swipeout-content item-content\"><div class=\"post_entry\"><div style=\"width:20%;\" class=\"post_thumb\"><img src=\""+value[22]+"\" alt=\"\" title=\"\" /></div><div style=\"width:50%;\" class=\"post_details\"><h2>"+value.position+"</h2><p>"+value[23]+"</p><span class=\"post_date\">24.02.2015</span><span class=\"post_comments\"><a href=\"#\"></a></span></div><div class=\"buttons-right\"> <a onclick=\"remList('"+value.position+"','"+value[23]+"','"+value.location+" "+value[9]+"','"+value[22]+"','"+value.openingcount+"','"+value.requirements+"','"+value.workexp+"','"+value.description+"','"+value.minsalary+" - "+value.maxsalary+"',"+stuIds+","+value.idjob+")\"> <input style=\"background-color:red;\"  type=\"button\" name=\"submit\" class=\"form_submit\" id=\"\" value=\"Remove\"/></a><a onclick=\"sendMailRes('"+value.position+"','"+value[23]+"','"+value.location+" "+value[9]+"','"+value[22]+"','"+value.openingcount+"','"+value.requirements+"','"+value.workexp+"','"+value.description+"','"+value.minsalary+" - "+value.maxsalary+"',"+stuIds+","+value.idjob+")\"><input  type=\"button\" name=\"submit\" class=\"form_submit\" id='apb"+value.idjob+"' value=\"Apply\"/></a>applied on 12.12.12</div></div></div></div></li></a><div>";
                     }
                     }
